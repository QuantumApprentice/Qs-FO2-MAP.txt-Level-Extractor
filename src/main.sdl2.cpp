...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("Dear ImGui SDL2+OpenGL3 example", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)(640 * main_scale), (int)(480 * main_scale), window_flags);
    if (window == nullptr)
    {
...
#endif
    {
        ...
        while (SDL_PollEvent(&event))
        {
            ...
            if (event.type == SDL_KEYDOWN) {
                key_callback(event.key.keysym.sym);
